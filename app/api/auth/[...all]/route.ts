...
//   // ici ton config global
//   rules: [], // ou d’autres règles par défaut
// });
...
// } satisfies SlidingWindowRateLimitOptions<["fingerprint"]>;
...
//       return aj.withRule(protectSignup(signupOptions))
